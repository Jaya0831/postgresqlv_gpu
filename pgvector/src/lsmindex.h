...
// Global macro to indicate whether GPU CuVS is used
// Set this to 1 to enable GPU indexes: GPU_CUVS_IVF_FLAT (for IVFFLAT), GPU_CUVS_CAGRA (for HNSW)
// Set to 0 to use CPU indexes: FAISS IVFFLAT, HNSW
// Requires knowhere built with -DWITH_CUVS=ON and a CUDA-capable GPU
#ifndef USE_GPU_CUVS
#define USE_GPU_CUVS 1
#endif
...
// storage
#define VECTOR_STORAGE_BASE_DIR "/ssd_root/ptandra/pg_vector_extension_indexes/"
