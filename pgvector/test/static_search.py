...
# This is for the ground truth file in the custom binary format (generated by diskann's compute_ground_truth tool)
...
# hnswlib insert sift10M
# python static_search.py --do-insert \
#   --file /scratch1/zhan4404/dataset/sift1b/bigann_base.bvecs \
#   --num 1000000000 \
#   --host localhost --port 5434 --user liu4127 --dbname postgres --tablename bigann_vectors

# hnswlib build sift10M
# python static_search.py --do-index \
#   --file /scratch1/zhan4404/dataset/sift1b/bigann_base.bvecs \
#   --index-type hnsw --M 16 --ef-construction 40 \
#   --host localhost --port 5434 --user liu4127 --dbname postgres --tablename bigann_vectors